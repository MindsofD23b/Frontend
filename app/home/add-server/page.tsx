  ...
  return (
    <>
      ...
      <div className="flex items-center gap-3">
        ...
        <button
          type="button"
          className="h-12 w-12 rounded-full bg-gradient-to-br from-red-500 to-red-700 text-white shadow-[0_0_18px_rgba(255,60,60,0.6)] hover:scale-105 transition"
      ...
      <div className="flex-1 rounded-2xl bg-black/40 backdrop-blur-xl p-6 ring-1 ring-white/10 shadow-2xl">
        <div className="h-full rounded-3xl bg-gradient-to-br from-[#161616]/80 to-[#1F1F1F]/80 p-6 ring-1 ring-white/10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 h-full">
            ...
            {/* Small */}
            <div className="rounded-3xl bg-gradient-to-b from-[#242424] to-[#1A1A1A] p-6 flex flex-col ring-1 ring-orange-500/20 shadow-[0_0_25px_rgba(255,120,40,0.15)] hover:shadow-[0_0_35px_rgba(255,120,40,0.35)] transition h-[520px]">
              {/* Header fixed */}
              <div className="flex items-start justify-between">
                <h3 className="text-white font-semibold tracking-wide">
                  Small Package
                </h3>
                <span className="rounded-full bg-orange-500/20 px-3 py-1 text-xs text-orange-200 ring-1 ring-orange-400/30">
                  Starter
                </span>
              </div>
              ...
              <div className="mt-4 flex-1 overflow-auto pr-2 space-y-4">
                <div className="grid gap-2 text-sm text-white/70">
                  <div className="flex items-center justify-between">
                    <span>RAM</span><span className="text-white font-semibold">16 GB</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>CPU</span><span className="text-white font-semibold">2 vCores</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Storage</span><span className="text-white font-semibold">30 GB SSD</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Players</span><span className="text-white font-semibold">Up to 8</span>
                  </div>
                </div>
            ...
            {/* Big */}
            <div className="rounded-3xl bg-gradient-to-b from-[#262626] to-[#1C1C1C] p-6 flex flex-col ring-2 ring-red-500/40 shadow-[0_0_35px_rgba(255,60,60,0.35)] hover:shadow-[0_0_45px_rgba(255,60,60,0.6)] transition relative h-[520px]">
              ...
              <div className="flex items-start justify-between mt-3">
                ...
                <span className="rounded-full bg-red-500/20 px-3 py-1 text-xs text-red-200 ring-1 ring-red-400/30">
                  Performance
                </span>
              </div>
              ...
              <div className="mt-4 flex-1 overflow-auto pr-2 space-y-4
                ...
                <div className="grid gap-2 text-sm text-white/70">
                  <div className="flex items-center justify-between">
                    <span>RAM</span><span className="text-white font-semibold">32 GB</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>CPU</span><span className="text-white font-semibold">4 vCores</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Storage</span><span className="text-white font-semibold">80 GB NVMe</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span>Players</span><span className="text-white font-semibold">Up to 20</span>
                  </div>
                </div>
            ...
            {/* Custom */}
            <div className="rounded-3xl bg-gradient-to-b from-[#222222] to-[#181818] p-6 flex flex-col ring-1 ring-white/15 shadow-[0_0_20px_rgba(255,255,255,0.08)] hover:ring-white/30 transition h-[520px]">
              {/* Header fixed */}
              <div className="flex items-start justify-between">
                <h3 className="text-white font-semibold tracking-wide">
                  Custom
              ...
              <div className="mt-4 flex-1 overflow-auto pr-2 space-y-4">
                ...
                <div className="rounded-2xl bg-gradient-to-r from-[#0f0f0f] to-[#1a1a1a] ring-1 ring-white/10 p-4">
                  ...
                  <p className="mt-2 text-sm text-white/70">
                    Networks, special modpacks, performance-heavy worlds, or anything that needs a tailored setup.
                  </p>
                </div>
              </div>
