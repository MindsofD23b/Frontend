  ...
  return (
    <>
      <div className="h-20 rounded-2xl bg-[#2A2A2A] px-6 flex items-center">
        <div className="text-white text-lg font-semibold">Delete Server</div>
      </div>

      <div className="flex-1 rounded-2xl bg-[#2A2A2A] p-6 overflow-auto">
        <p className="text-sm text-white/70 mb-4">
          Select a server to remove it from your list. This is a UI action (no backend deletion yet).
        </p>
          ...
          {servers.map((s) => (
            ...
            >
              ...
              <button
                ...
                className="h-10 w-10 rounded-full bg-red-500/80 hover:bg-red-500 flex items-center justify-center transition"
